            ...
            <div class="paddingProfile">
                <div class="contentProfile">
                    ...
                    <form id="form1" runat="server" >
                        ...
                        <asp:TextBox ID="date" runat="server" type="date" name="postdate" class="inputField" placeholder="Date of Notes" required="required" disabled ="disabled" ></asp:TextBox><br /><br />
                        <asp:Button ID ="submitBtn" runat="server" name="button" CssClass="btn btn-primary" Text="Submit" />                    
                    </form>
                </div>
            </div>
     </div>
